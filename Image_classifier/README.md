...
This project aims to create different models of Machine Learning (ML) to solve the following problem: given an image, classify it as an image that contains a dog, a cat or a panda using 3000 images from a dataset. For this project, three ML models will be used for the image classification:
